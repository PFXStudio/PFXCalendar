...
class CalendarCollectionViewModel: RxViewModel {
    struct Input {
    ...
    var input: CalendarCollectionViewModel.Input!
    var output: CalendarCollectionViewModel.Output!
    var dependency: CalendarCollectionViewModel.Dependency!
    ...
    init(dependency: Dependency) {
        ...
        self.input = CalendarCollectionViewModel.Input(load: self.loadSubject.asObserver())
        self.output = CalendarCollectionViewModel.Output(sections: self.sectionsSubject.asObservable(),
